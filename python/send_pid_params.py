...
# Motor a (LEFT MOTOR)
pid_msg.motor_a_kp = 1.4
pid_msg.motor_a_ki = 0#5.8
pid_msg.motor_a_kd = 0#-0.01#0.05
pid_msg.motor_a_Tf = 25.0

# Motor c (RIGHT_MOTOR)
pid_msg.motor_c_kp = 1.4
pid_msg.motor_c_ki = 0#5.8
pid_msg.motor_c_kd = 0#-0.01#0.05
...
# We don't use this
pid_msg.motor_b_kp = np.random.random()
